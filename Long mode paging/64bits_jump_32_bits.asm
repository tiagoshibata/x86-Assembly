...
;Checa A20:
    ...
    mov     ah, al
    not     al;al=!al
    xchg    al, [100000h];0FFFFh:10h=al,al=0FFFFh:10h
    cmp     ah, [0]
	xchg 	al,[100000h]
	je A20_setup.complete;pula para ativação da porta A20
...
pmode_setup:
   ...
   jmp 24:pmode;24 é a posição do code descriptor de código no GDT. Ainda sem IRQ's
...
no_long_mode_msg 	db 'Processador não é 64 bits',0
no_E820_msg 		db 'BIOS int 0E820h não suportado',0
;no_paging_msg		db 'PAE não é suportada',0
